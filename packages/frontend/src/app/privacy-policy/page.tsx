        ...
        <article className="prose prose-slate dark:prose-invert max-w-none prose-headings:scroll-mt-20 prose-a:text-primary prose-a:no-underline hover:prose-a:underline">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Privacy Policy) refers to Summarize My Mails.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Summarize My Mails,
                accessible from{" "}
                <a
                  href="https://smm-frontend-six.vercel.app"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://smm-frontend-six.vercel.app
                </a>
                .
              </p>
            </li>
          ...
          <ul>
            <li>
              ...
              use of our Service, prior to contact You.
            </li>
            <li>

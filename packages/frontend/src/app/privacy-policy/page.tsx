      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <article className="prose prose-slate dark:prose-invert max-w-none prose-headings:scroll-mt-20 prose-a:text-primary prose-a:no-underline hover:prose-a:underline">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Summarize My Mails.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Summarize My Mails, accessible from <a href="https://smm-frontend-six.vercel.app" rel="external nofollow noopener" target="_blank">https://smm-frontend-six.vercel.app</a>.</p>
                </li>
                <li>
            ...
            <ul>
                <li><strong>With Service Providers:</strong> We may share Your Personal Data with Service Providers to monitor and analyze the use of our Service, prior to contact You.</li>

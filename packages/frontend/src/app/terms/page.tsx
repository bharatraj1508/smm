  ...
  return (
    <div className="min-h-screen bg-background py-16 px-4 sm:px-8">
      <div className="container mx-auto max-w-4xl">
        ...
        <article className="prose prose-slate dark:prose-invert max-w-none prose-headings:scroll-mt-20 prose-a:text-primary prose-a:no-underline hover:prose-a:underline">
            ...
            <ul>
                ...
                <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to InboxIQ.</li>
                ...
                <li><strong>Website</strong> refers to InboxIQ, accessible from <a href="https://smm-frontend-six.vercel.app" target="_blank" rel="noopener noreferrer">https://smm-frontend-six.vercel.app</a></li>
            ...
            <ul>
                <li>By email: bharat.raj1508@gmail.com</li>
            </ul>
        </article>
      </div>
    </div>
